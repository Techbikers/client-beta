...
export const fetchRideRegistrationDetails = createAction(FETCH_RIDE_REGISTRATION_DETAILS, (rideId, userId) => ({
  rideId,
  userId
}));

export const REGISTER_USER_FOR_RIDE = 'REGISTER_USER_FOR_RIDE';
export const registerUserForRide = createAction(
  REGISTER_USER_FOR_RIDE,
...
export const chargeUserForRide = createAction(
  CHARGE_USER_FOR_RIDE,
