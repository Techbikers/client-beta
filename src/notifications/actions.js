...
const createNotification = createAction(CREATE_NOTIFICATION, props => ({ id: ++lastId, ...props }));
...
export const updateProgressNotification = createAction(UPDATE_PROGRESS_NOTIFICATION, (id, progress) => ({
  id,
  progress
}));
