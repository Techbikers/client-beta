...
const initialState = {
  page: {
    meta: {
      ...
      'og:description':
        'On June 24th, 60+ techies will ride from Paris to London. Over the 3 day, 200 mile ride they will raise $75000+ for Room to Read.'
    }
  }
};

const sagas = [authSagas, chapterSagas, rideSagas, sponsorSagas, userSagas, notificationSagas, fundraiserSagas];
