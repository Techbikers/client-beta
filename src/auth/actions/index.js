...
export const authenticateUser = createAction(AUTHENTICATE_USER, (email, password) => ({ email, password }));

export const AUTHENTICATE_SOCIAL_USER = 'AUTHENTICATE_SOCIAL_USER';
export const authenticateSocialUser = createAction(
...
export const exchangeToken = createAction(EXCHANGE_TOKEN, (backend, code, state) => ({ backend, code, state }));
...
export const beginPasswordReset = createAction(BEGIN_PASSWORD_RESET, identity, email => ({
  analytics: {
    eventType: EventTypes.track,
    eventPayload: {
      properties: { email }
...
export const storeAuthCallback = createAction(STORE_AUTH_CALLBACK, (returnTo, action) => ({ returnTo, action }));

export const CLEAR_AUTH_CALLBACK = 'CLEAR_AUTH_CALLBACK';
export const clearAuthCallback = createAction(CLEAR_AUTH_CALLBACK);

export const LOGOUT = 'LOGOUT';
export const logout = createAction(LOGOUT, identity, () => ({ analytics: EventTypes.reset }));
